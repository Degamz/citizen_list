...
const Citizens = () => {
  const initialCitizens = [
    ...
    { id: 2, name: 'Kean Jane', age: 30, address: 'Tungkil', status: 'Inactive' },
    { id: 3, name: 'Mike check', age: 35, address: 'Bacay', status: 'Active' },
    { id: 4, name: 'Shan Milby', age: 40, address: 'Ward 2', status: 'Inactive' },
    { id: 5, name: 'Jhonry', age: 45, address: 'Ward 4', status: 'Active' },
    { id: 6, name: 'Kean Jane', age: 50, address: 'Calajoan', status: 'Inactive' },
    { id: 7, name: 'Mike check', age: 55, address: 'Tunghaan', status: 'Active' },
    { id: 8, name: 'Shan Milby', age: 60, address: 'Naga', status: 'Inactive' },
    { id: 9, name: 'Jhonry', age: 65, address: 'San Fernando', status: 'Active' },
  ...
  const toggleStatus = (id) => {
    setCitizens(citizens.map(citizen => 
      citizen.id === id ? { ...citizen, status: citizen.status === 'Active' ? 'Inactive' : 'Active' } : citizen
    ));
  };
